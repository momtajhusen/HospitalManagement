...
@role('Admin|Pharmacist|Lab Technician')
    @module('Medicines', $modules)
        ...
        @role('Admin|Doctor|Accountant|Case Manager|Receptionist|Pharmacist|Lab Technician|Nurse')
            ...
            @endmodule
        @endrole
        @php($sectionName = Request::get('section') === null && !Request::is('hospital-schedules') && !Request::is('currency-settings') && !Request::is('operation-categories') && !Request::is('operations') && !Request::is('payment-gateways') ? 'general' : Request::get('section'))
        <li
            class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0  {{ Request::is('settings*', 'currency-settings*', 'hospital-schedules', 'operation-categories*', 'operations*', 'payment-gateways*') ? '' : 'd-none' }}">
        ...
        @endmodule
        @role('Admin')
            <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ Request::is('settings*', 'currency-settings*', 'hospital-schedules', 'operation-categories*', 'operations*', 'payment-gateways*') ? '' : 'd-none' }}">
